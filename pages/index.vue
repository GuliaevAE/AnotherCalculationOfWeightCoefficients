<template>
  <NuxtChild :datas='rendData' :datasWithWeight='allitems3' />
...
export default {
  ...
  computed: {
    ...
    rendData() {
      ...
      // console.log(ТолькоМаксимальнаяЧастотаПамяти)
      // console.log(ТолькоМаксимальныйОбъемПамяти)
      // console.log(ТолькоКоличествоКаналовПамяти)
      // console.log(ТолькоКоличествоСлотовPCIE1)
      // console.log(ТолькоКоличествоСлотовПамяти)
      ...
      allItems1.map(x => {
        if (x['type'] === 'Видеокарта') {
          ...
          x.transformations.рейтинг = (x.transformations.видеокартаНорм.частоставидеокарты + x.transformations.видеокартаНорм.памятьвидеокарты + x.transformations.видеокартаНорм.ЧастотаПамяти - x.transformations.видеокартаНорм.Техпроцесс + x.transformations.видеокартаНорм.РазрядностьШиныПамяти) * this.getCoefficients.w1
        }
        ...
        if (x['type'] === 'Процессор') {
          ...
          x.transformations.рейтинг = (x.transformations.процессорНорм.частостапроцессора + x.transformations.процессорНорм.числопотоков + x.transformations.процессорНорм.КоличествоЯдер + x.transformations.процессорНорм.КоличествоКаналов + x.transformations.процессорНорм.ЧастотаГрафическогоЯдра) * this.getCoefficients.w2
        }
        ...
        if (x['type'] === 'Оперативная память') {
          ...
          x.transformations.рейтинг = (x.transformations.оперативкаНорм.объем + x.transformations.оперативкаНорм.частотаоперативки + x.transformations.оперативкаНорм.КоличествоМодулей + x.transformations.оперативкаНорм.ОбъемМодуля) * this.getCoefficients.w3
        }
    ...
    allitems3() {
      ...
      // 
      // alls = alls.filter(x => x.общаяцена < this.budget)
      // console.log(alls.filter(x => x.общаяцена < this.getBudget))
      return alls
