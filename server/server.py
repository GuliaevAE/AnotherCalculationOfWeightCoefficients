...
#     connection = psycopg2.connect("""
#     host=rc1b-cygvn6p565rd38gy.mdb.yandexcloud.net
#     port=6432
#     sslmode=verify-full
#     dbname=db1
#     user=user1
#     password=ggeasyvp1483
...
# """)
    ...
    proxys = ["193.200.12.126:8052","193.151.190.14:8052","193.233.251.231:8052"]
    proxy = "193.200.12.126:8052"
    
    options = webdriver.ChromeOptions()
    options.add_argument('--ignore-certificate-errors-spki-list')
    options.add_argument('--ignore-ssl-errors')

    # options.add_argument(f"--proxy-server=77.220.141.19:3128")

    driver = webdriver.Chrome(ChromeDriverManager().install(), chrome_options=options)
    driver1 = webdriver.Chrome(ChromeDriverManager().install(), chrome_options=options)
...
# """)
    ...
    # options.add_argument("--proxy-server=87.255.12.183:3129")
